...
# flake8: noqa
#
# bb_tracking documentation build configuration file copied from bb_binary project.
#
...
def get_modules():
    ...
    modules = [m for m in modules if not (m.startswith('bb_tracking') or m.startswith('.'))]
    mock_modules = []
...
project = u'bb_tracking'
copyright = u'2016, BioroboticsLab FU Berlin'
author = u'Benjamin Rosemann'
...
htmlhelp_basename = 'bb_trackingdoc'
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(bb_tracking.__file__))
